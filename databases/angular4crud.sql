...
Source Database       : angular4crud

Target Server Type    : MYSQL
Target Server Version : 50505
File Encoding         : 65001

Date: 2017-07-23 21:34:43
*/
...
-- Records of husband
-- ----------------------------
INSERT INTO `husband` VALUES ('1', 'สุพจน์', 'เป็นความลับ', 'นักวิชาการสาธารณสุข', '35000.0000', 'เกี่ยวกับสาธารณสุขในตัวจังหวัด');
INSERT INTO `husband` VALUES ('2', 'เชิดชัย', 'ลับสุด ๆ', 'นักวิชาการคอมพ์', '22000.0000', 'ลูกน้องคนข้างบน');
INSERT INTO `husband` VALUES ('3', 'มีศักดิ์', 'ปกปิดนามสกุล', 'เกี่ยวกับคอมพิวเตอร์', '22000.0000', 'สาสุขในพื้นที่ห่างไกล');

-- ----------------------------
-- Table structure for `minor_wife`
-- ----------------------------
DROP TABLE IF EXISTS `minor_wife`;
CREATE TABLE `minor_wife` (
  `minor_id` int(11) NOT NULL AUTO_INCREMENT,
  `husband_id` int(11) NOT NULL,
  `nickname` varchar(50) NOT NULL,
  `monthly_expenses` decimal(14,4) NOT NULL,
  `province_id` varchar(2) NOT NULL,
  PRIMARY KEY (`minor_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of minor_wife
-- ----------------------------
